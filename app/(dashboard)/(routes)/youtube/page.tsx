...
import { Copy, CopyCheck, SendHorizonalIcon, ShoppingBagIcon, SunIcon, YoutubeIcon } from "lucide-react"
...
const Youtube = () => {
  ...
  return (
    <div>
      <Heading title="Youtube Video Script" description="Have an Idea? Quickly generate a youtube video script around it" icon={YoutubeIcon} iconColor="text-red-700" bgColor="bg-red-700/10" />
                ...
                <FormItem className=" col-span-12 lg:col-span-10" >
                  <FormControl className="m-0 p-0">
                    <Input className="border-0 outline-none focus-visible:ring-0 focus-visible:ring-transparent  "
                      disabled={isLoading}
                      placeholder="Your idea here " {...field} />
                  </FormControl>
