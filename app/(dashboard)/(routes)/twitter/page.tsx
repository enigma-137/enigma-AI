...
import { Copy, CopyCheck, SendHorizonalIcon, ShoppingBagIcon, SunIcon, TwitterIcon } from "lucide-react"
...
const Twitter = () => {
  ...
  return (
    <div>
      <Heading title="Tweet Generation" description=" Generate simple tweets  " icon={TwitterIcon} iconColor="text-blue-700" bgColor="bg-blue-700/10" />
                ...
                <FormItem className=" col-span-12 lg:col-span-10" >
                  <FormControl className="m-0 p-0">
                    <Input className="border-0 outline-none focus-visible:ring-0 focus-visible:ring-transparent  "
                      disabled={isLoading}
                      placeholder="The state of the crypto market.. " {...field} />
                  </FormControl>
