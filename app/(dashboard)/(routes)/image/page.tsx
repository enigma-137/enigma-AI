...
const ImagePage = () => {
  ...
  return (
    <div>
      <Heading title="Image Generator" description="Generate stunning Images by just describing them" icon={ImageDown} iconColor="text-green-500" bgColor="bg-green-500/10" />
          ...
          <Form {...form} >
            ...
            >
                ...
                <FormItem className=" col-span-12 lg:col-span-6" >
                  <FormControl className="m-0 p-0">
                    <Input className="border-0 outline-none focus-visible:ring-0 focus-visible:ring-transparent  "
                      disabled={isLoading}
                      placeholder="A pattern picture for nice clothes  " {...field} />
                  </FormControl>
              ...
              <Button  className="col-span-12 lg:col-span-2 w-full" disabled={isLoading} >
                ...
                {images.length > 1 && !isLoading ? "Regenerate" : "Generate"}
