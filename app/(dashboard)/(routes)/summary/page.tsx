...
import { Copy, CopyCheck, SendHorizonalIcon, ShoppingBagIcon, SunIcon } from "lucide-react"
...
const Summarizer = () => {
  ...
  return (
    <div>
      <Heading title="Text Summarizer" description=" Summarize text into concise summaries  " icon={SunIcon} iconColor="text-yellow-700" bgColor="bg-yellow-700/10" />
          ...
          <Form {...form} >
            ...
            >
                ...
                <FormItem className=" col-span-12 lg:col-span-10" >
                  <FormControl className="m-0 p-0">
                    <Input className="border-0 outline-none focus-visible:ring-0 focus-visible:ring-transparent  "
                      disabled={isLoading}
                      placeholder="Your text here " {...field} />
                  </FormControl>
              ...
              <Button className="col-span-12 lg:col-span-2 w-full" disabled={isLoading} >
                {/* <SendHorizonalIcon /> */}
               {messages.length > 1 && !isLoading ? "Regenerate" : "Summarize"}
